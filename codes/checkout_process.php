...
if (isset($_SESSION["uid"])) {
	...
	(`user_id`,`nama`, `email`,`address1`, `address2`, `cardname`, `cardnumber`, `prod_count`,`total`) 
	VALUES ('$user_id','$nama','$email', '$address1', '$address2', '$cardname', '$cardnumber',
    '$jumlah','$subtotal')";
    ...
    if(mysqli_query($con,$sql)){
        ...
        while($i<=$jumlah){
            ...
            (`order_pro_id`,`order_id`,`product_id`,`qty`,`subtotal`) 
