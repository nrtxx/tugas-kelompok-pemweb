<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 mt-4 border-top bg-light">
    <div class="col-md-4 d-flex align-items-center mx-3">
      <a href="index.php" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
        <img src="assets/img/icon.png" style="width: 50px;" alt="Icon">
      </a>
      <span class="text-muted">&copy; 2021 Avengers Assemble</span>
    </div>

    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex mx-3">
      <li class="ms-3"><a class="text-muted" href="https://twitter.com/"><svg class="bi" width="24" height="24">
